Function Set-FireWallState{
	...
	If((Get-Service mpssvc).Status -ne 'Running'){Set-Service mpssvc -StartupType Automatic -ErrorAction SilentlyContinue;Start-Service mpssvc -ErrorAction SilentlyContinue}
